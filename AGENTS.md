...
### Note on `text_to_audio/AGENTS.md`

That file is stale — it documents an OpenAI implementation that was replaced by ElevenLabs. Ignore it; this root AGENTS.md is authoritative.
